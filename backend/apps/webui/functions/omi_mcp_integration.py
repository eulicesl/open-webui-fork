"""
title: MindX Memory Integration
author: MindX Team
author_url: https://github.com/mindx-team
funding_url: https://github.com/mindx-team
version: 1.0.0
description: MindX Memory powered by OMI MCP - Intelligence Amplified
"""
...
class Filter:
    ...
    def inlet(self, body: dict, __user__: Optional[dict] = None) -> dict:
        ...
        if any(trigger in last_message for trigger in omi_triggers):
            omi_html = f"""## 🧠 MindX Memory - AI Assistant
...
<div style="border-radius: 12px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.1); margin: 15px 0;">
    <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 12px 20px;">
        <div style="display: flex; justify-content: space-between; align-items: center;">
            <span style="font-weight: 600; font-size: 16px;">🧠 MindX Memory - AI Assistant</span>
            <span style="font-size: 12px; opacity: 0.9;">Powered by OMI • Intelligence Amplified</span>
        </div>
    </div>
